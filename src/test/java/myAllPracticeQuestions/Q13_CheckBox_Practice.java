...
public class Q13_CheckBox_Practice {
    ...
    public void test() {
        ...
        Assert.assertTrue("secili degil",checkbox1.isSelected());
        Assert.assertTrue("secili degil",checkbox3.isSelected());

        // checkbox2 elementinin secili olmadıgını test edin
        Assert.assertFalse("secili", checkbox2.isSelected());
    }
}
