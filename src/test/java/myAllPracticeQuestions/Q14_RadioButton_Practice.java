...
public class Q14_RadioButton_Practice {
    ...
    public void test() {
        ...
        radioButton2.click();
        // option2 elementlerinin secili oldugunu Test edin
        Assert.assertTrue("secili degil", radioButton2.isSelected());
        // option1 elementlerinin secili olmadıgını test edin
        // option3 elementlerinin secili olmadıgını test edin
        Assert.assertFalse("secili",radioButton1.isSelected());
        Assert.assertFalse("secili",radioButton3.isSelected());
